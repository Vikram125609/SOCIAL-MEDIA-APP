                    ...
                    data.map((data) => {
                        return (
                            <Link key={data._id} style={{ textDecoration: 'none' }} to={"/profile/" + data._id} >
                                <Box sx={{ display: 'flex', padding: '10px', margin: '10px 0px 10px 0px', borderRadius: '5px', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0px 0px 10px 0px rgba(0,0,0,0.43)' }} key={data._id}>
