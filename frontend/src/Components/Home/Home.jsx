                ...
                loading ? (<Loader />) : (
                    <Box sx={{ display: 'flex' }} my={marginTop}>
                        ...
                        <Stack spacing={2} direction='column' flex={2}>
                            ...
                            {
                                feed.map((data, index) => {
                                    return <Feed key={index} post_id={data?._id} first_name={data?.user_id?.first_name} last_name={data?.user_id?.last_name} image={data?.user_id?.image} post={data?.image} likes={data?.likes} times={data?.createdAt} comments={data?.comments} />
                                })
                            }
                        </Stack>
                    </Box>
